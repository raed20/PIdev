...
class ReclamationController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($this->containsBadWord(text: $reclamation->getObjet()) || $this->containsBadWord(text: $reclamation->getDescription())) {
                $form->addError(new FormError('La réclamation contient de gros mots'));
            } else {
    ...
    #[Route('/back/{id}', name: 'app_reclamation_showback', methods: ['GET'])]
