 ...
 */
final class Version20240229110055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE investissement ADD user_id INT NOT NULL, CHANGE opport_id opport_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE investissement DROP user_id, CHANGE opport_id opport_id INT DEFAULT NULL');
    }
}
